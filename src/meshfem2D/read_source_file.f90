...
'Error: Total number of sources in DATA/SOURCE is different from that declared in the Par_file, please check...')
  ...
  do  i_source= 1,NSOURCES
    ...
    case (8)
      ...
      write(IMAIN,*) '  Source read from file:',trim(name_of_source_file(i_source)) ! lucas, name_of_source_file(i_source) is extactly the name_of_source_file in file SOURCE
    case (9)
