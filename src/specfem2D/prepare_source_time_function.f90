...
!              endif
          ...
          case (8)
            ...
            read(num_file,*) time, source_time_function(i_source,it,i_stage) ! lucas, here, the source_time_function should have alread times -factor. 
          ...
          case (9)
            ...
            DecT = t0 + tshift_src(i_source)
            t_used = (timeval-t0-tshift_src(i_source))
            Nc = TWO * f0_source(i_source) / burst_band_width(i_source) ! Nc=2*f0/burst_band_width;
