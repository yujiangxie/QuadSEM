...
subroutine assemble_MPI_scalar_m2(array_val1,npoin_val1, &
                                 array_e1,n_sls_loc, &
                                 array_val2_m2, npoin_val2, & !lucas, CTD-SEM
                                 array_val3,array_val4,npoin_val3)
  ...
  ! elastic
  integer :: npoin_val2 !lucas, nglob_elastic
  real(kind=CUSTOM_REAL), dimension(NDIM,npoin_val2), intent(inout) :: array_val2_m2
  ...
  real(kind=CUSTOM_REAL), dimension(max_ibool_interfaces_size_ac + &
    NDIM * max_ibool_interfaces_size_el + &
    2 * max_ibool_interfaces_size_po + &
    n_sls_loc*max_ibool_interfaces_size_ac, ninterface)  :: buffer_send_faces_scalar_m2, buffer_recv_faces_scalar_m2
  ...
  if (NPROC > 1) then
    ...
    buffer_recv_faces_scalar(:,:) = 0._CUSTOM_REAL
    !lucas1, CTD-SEM
    buffer_send_faces_scalar_m2(:,:) = 0._CUSTOM_REAL
    buffer_recv_faces_scalar_m2(:,:) = 0._CUSTOM_REAL
    ...
    do iinterface = 1, ninterface
      ...
      do idim = 1,NDIM
        do i = 1, nibool_interfaces_elastic(iinterface)
          ...
          buffer_send_faces_scalar_m2(ipoin,iinterface) = array_val2_m2(idim,iglob) !lucas2, CTD-SEM
      ...
      ! non-blocking send
      call isend_cr(buffer_send_faces_scalar_m2(1,iinterface), nbuffer_points, my_neighbors(iinterface),11, &  ! lucas, my_neighbors=dest in parallel.f90, i.e., cpu no.
                    msg_send_requests(iinterface))
      ! starts a blocking receive
      call irecv_cr(buffer_recv_faces_scalar_m2(1,iinterface),nbuffer_points,my_neighbors(iinterface),11, &
                    msg_recv_requests(iinterface))
    ...
    do iinterface = 1, ninterface
      ...
      do idim = 1,NDIM
        do i = 1, nibool_interfaces_elastic(iinterface)
          ...
          array_val2_m2(idim,iglob) = array_val2_m2(idim,iglob) + buffer_recv_faces_scalar_m2(ipoin,iinterface) !lucas4, CTD-SEM
  ...
  end subroutine assemble_MPI_scalar_m2
