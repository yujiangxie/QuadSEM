...
! holds input parameters given in DATA/Par_file
  ...
  logical :: CTD_SEM !lucas, CTD-SEM 
  logical :: compute_appro_Hessian
  logical :: Full_Hessian_by_Wavefield_Stored ! lucas, CTD-SEM
  ...
  character(len=MAX_STRING_LEN) :: TOMOGRAPHY_FILE_m2 !lucas, CTD-SEM
