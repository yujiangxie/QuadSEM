...
!--------------------
  ...
  subroutine read_material_parameters_p(i,icodematread,val0read,val1read,val2read,val3read, &
                         ...
                         val11read,val12read) ! lucas, make sure to get the 15 parameters set/input by the user in Par_file.
...
!--------------------
  ...
  subroutine open_parameter_file() ! lucas: just open and do nothing related to vp, vs
